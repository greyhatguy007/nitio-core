package com.greyhatguy007.data.mapping

import com.greyhatguy007.data.parser.toListThumbnail
import com.greyhatguy007.domain.data.model.browse.album.Track
import com.greyhatguy007.domain.data.model.canvas.CanvasResult
...
import com.greyhatguy007.domain.data.model.searchResult.artists.ArtistsResult
import com.greyhatguy007.domain.data.model.searchResult.playlists.PlaylistsResult
import com.greyhatguy007.domain.data.model.searchResult.songs.Album
import com.greyhatguy007.domain.data.model.searchResult.songs.Artist
import com.greyhatguy007.domain.data.model.searchResult.songs.SongsResult
import com.greyhatguy007.domain.data.model.searchResult.songs.Thumbnail
import com.greyhatguy007.domain.data.model.searchResult.videos.VideosResult
...
import com.greyhatguy007.spotify.model.response.spotify.CanvasResponse
import com.greyhatguy007.spotify.model.response.spotify.SpotifyLyricsResponse
...
internal fun Track.toSongItemForDownload(): SongItem =
    SongItem(
        ...
        artists =
            this.artists?.map {
                com.greyhatguy007.kotlinytmusicscraper.models.Artist(
                    id = it.id ?: "",
                    name = it.name,
                )
            } ?: emptyList(),
        album =
            com.greyhatguy007.kotlinytmusicscraper.models.Album(
                id = this.album?.id ?: "",
...
internal fun SearchSuggestions.toDomainSearchSuggestions(): com.greyhatguy007.domain.data.model.searchResult.SearchSuggestions =
    com.greyhatguy007.domain.data.model.searchResult.SearchSuggestions(
...
internal fun AccountInfo.toDomainAccountInfo(): com.greyhatguy007.domain.data.model.account.AccountInfo =
    com.greyhatguy007.domain.data.model.account.AccountInfo(
        name = this.name,
        email = this.email,
        pageId = this.pageId,
