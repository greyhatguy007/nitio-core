package com.greyhatguy007.media3.exoplayer
...
import com.greyhatguy007.media3.audio.BiquadFilter
import com.greyhatguy007.media3.audio.ConvolutionReverbAudioProcessor
import com.greyhatguy007.media3.audio.CrossfadeFilterAudioProcessor
import com.greyhatguy007.media3.audio.EchoAudioProcessor
import com.greyhatguy007.media3.audio.EqualizerAudioProcessor
import com.greyhatguy007.media3.audio.EqualizerCurve
import com.greyhatguy007.media3.audio.SleepFadeAudioProcessor
import com.greyhatguy007.media3.exoplayer.CrossfadeExoPlayerAdapter.Companion.SPEED_PITCH_STEP
import com.greyhatguy007.media3.service.mediasourcefactory.MergingMediaSourceFactory
                        ...
                        if (retryCount < maxRetryCount) {
                            ...
                            coroutineScope.launch {
                                try {
                                    ...
                                    streamRepository.invalidateFormat("${com.greyhatguy007.common.MERGING_DATA_TYPE.VIDEO}$currentVideoId")
