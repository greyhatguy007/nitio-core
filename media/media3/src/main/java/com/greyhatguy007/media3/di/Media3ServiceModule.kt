package com.greyhatguy007.media3.di
...
import com.greyhatguy007.common.Config.CANVAS_CACHE
import com.greyhatguy007.common.Config.DOWNLOAD_CACHE
import com.greyhatguy007.common.Config.MAIN_PLAYER
import com.greyhatguy007.common.Config.PLAYER_CACHE
...
import com.greyhatguy007.media3.cast.CastHandoffManager
import com.greyhatguy007.media3.cast.CastStreamResolver
import com.greyhatguy007.media3.exoplayer.CrossfadeExoPlayerAdapter
import com.greyhatguy007.media3.extension.isFullyCached
import com.greyhatguy007.media3.repository.CacheRepositoryImpl
import com.greyhatguy007.media3.service.SimpleMediaService
import com.greyhatguy007.media3.service.callback.SimpleMediaSessionCallback
import com.greyhatguy007.media3.service.download.DownloadUtils
import com.greyhatguy007.media3.service.mediasourcefactory.MergingMediaSourceFactory
import com.greyhatguy007.media3.utils.CoilBitmapLoader
...
private val mediaServiceModule =
    module {
        ...
        // Cast support in the full build; org.com.greyhatguy007.nitio.cast no-ops back to the same instance
