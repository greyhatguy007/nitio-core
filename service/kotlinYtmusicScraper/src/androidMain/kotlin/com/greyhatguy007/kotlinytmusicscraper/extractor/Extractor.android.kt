...
actual class Extractor {
    ...
    actual fun saveAudioWithThumbnail(
        ...
        try {
            ...
            if (FileSystem.SYSTEM.exists("$filePath-com.greyhatguy007.nitio.mp3".toPath())) {
                FileSystem.SYSTEM.delete("$filePath-com.greyhatguy007.nitio.mp3".toPath())
            }
        } catch (e: IOException) {
            e.printStackTrace()
        }
        ...
        val commandInject =
            listOf(
                ...
                "$filePath-com.greyhatguy007.nitio.mp3",
            ).joinToString(" ")
        val sessionInject =
            FFmpegKit.execute(
                commandInject,
