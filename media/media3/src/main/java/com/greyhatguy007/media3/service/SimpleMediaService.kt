package com.greyhatguy007.media3.service
...
import com.greyhatguy007.common.MEDIA_NOTIFICATION
...
import com.greyhatguy007.media3.extension.toCommandButton
...
internal class SimpleMediaService :
    MediaLibraryService(),
    KoinComponent {
    private val coroutineScope by inject<CoroutineScope>(named(com.greyhatguy007.common.Config.SERVICE_SCOPE))
    ...
    private val player: Player by inject<Player>(qualifier = named(com.greyhatguy007.common.Config.MAIN_PLAYER))
