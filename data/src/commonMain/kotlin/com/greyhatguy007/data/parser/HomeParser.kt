package com.greyhatguy007.data.parser

import com.greyhatguy007.domain.data.model.home.Content
import com.greyhatguy007.domain.data.model.home.HomeItem
...
import com.greyhatguy007.kotlinytmusicscraper.models.SectionListRenderer
...
fun Thumbnail.toThumbnail(): com.greyhatguy007.domain.data.model.searchResult.songs.Thumbnail =
    com.greyhatguy007.domain.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<com.greyhatguy007.domain.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<com.greyhatguy007.domain.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
